...
static ATL::_ATL_FUNC_INFO g_SinkDispInfo = {CC_STDCALL, VT_DISPATCH, 1, {VT_DISPATCH}};
static ATL::_ATL_FUNC_INFO g_SinkDispInfo2 = {CC_STDCALL, VT_DISPATCH, 2, {VT_DISPATCH,VT_BOOL | VT_BYREF}};

class CMainFrame :
	public ATL::CWindowImpl<CMainFrame, CWindow, ATL::CWinTraits<WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_THICKFRAME | WS_MINIMIZEBOX | WS_CLIPCHILDREN, 0> >,
...
public:
	DECLARE_WND_CLASS_EX(0, 0, COLOR_BTNFACE)
	CMainFrame();
	~CMainFrame();
	...
	BEGIN_MSG_MAP(CMainFrame)
		...
		COMMAND_ID_HANDLER(ID_NORMAL, OnCommand)
		COMMAND_ID_HANDLER(ID_COMPACT, OnCommand)
		COMMAND_ID_HANDLER(ID_CHANGEPASSWORD, OnCommand)
		COMMAND_ID_HANDLER(ID_TOOLS_CHANGEAUDIODEVICES, OnCommand)
		COMMAND_ID_HANDLER(ID_OPTIONS, OnCommand)
		COMMAND_ID_HANDLER(ID_WEBHELP, OnCommand)
		COMMAND_ID_HANDLER(ID_REPORTAPROBLEM, OnCommand)
	...
	BEGIN_SINK_MAP(CMainFrame)
		...
		SINK_ENTRY_INFO(1, PttLib::DIID_IPttEvents, PttLib::DISPID_ON_GET_CAN_SIGN_IN, &CMainFrame::OnGetCanSignIn, &g_SinkBoolInfo)
		SINK_ENTRY_INFO(1, PttLib::DIID_IPttEvents, PttLib::DISPID_ON_MESSAGE_IN_BEGIN, &CMainFrame::OnIncomingMessage, &g_SinkDispInfo)
		SINK_ENTRY_INFO(1, PttLib::DIID_IPttEvents, PttLib::DISPID_ON_AUDIO_MESSAGE_IN_START, &CMainFrame::OnMessageBegin, &g_SinkDispInfo2)
	END_SINK_MAP()
	...
	void __stdcall OnMessageBegin(PttLib::IAudioInMessage* pMsg,VARIANT_BOOL* pbCanBeActivated);
	void __stdcall OnIncomingMessage(PttLib::IMessage* pMsg);
};
