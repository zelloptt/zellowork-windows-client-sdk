...
public:
	...
	BEGIN_SINK_MAP(CMainForm)
		...
		SINK_ENTRY_INFO(1, PttLib::DIID_IPttEvents, PttLib::DISPID_ON_SIGN_IN_FAILED, &CMainForm::OnSignInFailed, &g_SinkEmptyInfo)
		...
		SINK_ENTRY_INFO(1, PttLib::DIID_IPttEvents, PttLib::DISPID_ON_MESSAGE_IN_BEGIN, &CMainForm::OnMessageInBegin, &g_SinkDispatchBoolInfo)
		...
		SINK_ENTRY_INFO(1, PttLib::DIID_IPttEvents, PttLib::DISPID_ON_AUDIO_MESSAGE_IN_START, &CMainForm::OnAudioMessageInStart, &g_SinkDispatchInfo)
...
private:
	...
	void __stdcall OnMessageInBegin(IDispatch* pMessage, VARIANT_BOOL* pbVal);
	...
	void __stdcall OnAudioMessageInStart(IDispatch* pMessage);
